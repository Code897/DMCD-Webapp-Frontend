...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    const handleMediaQueryChange = () => {
      setHeight(mediaQuery.matches ? 'calc(100vh - 81px)' : '100vh');
    };
  ...
  return (
    <>
      <div className='flex px-5 justify-center items-center flex-col' style={{
        backgroundImage: `url('https://img.freepik.com/free-photo/close-up-new-york-traffic_23-2150868240.jpg?t=st=1706327318~exp=1706330918~hmac=d5b4bef19fe2659b93fdaec27678f28b2817d098568fe4b24a5bd337a658c643&w=360')`,
        ...
        <div className='lg:grid grid-cols-3 lg:mb-11 mb-5'>
          <div className='text-white xl:pl-72 xl:pr-96 lg:pl-55 lg:pr-75 px-0 col-span-2 tracking-widest'>"DriveMyCarDriver in Jamshedpur - Your key to effortless travel. Expert drivers, reliable service, ensuring smooth journey through the streets of jamshedpur"</div>
